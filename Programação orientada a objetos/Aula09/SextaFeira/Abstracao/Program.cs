...
Console.Write("Quantas formas geometricas você quer digitar? :");
...
for (int i = 0; i < n; i++)
{
    ...
    {
        Console.WriteLine("Objeto selecinoado não está na lista! ");
    }


}

Console.WriteLine("Lista de formas digitadas e suas areas: " );

foreach (var figurinhas in formas)
{
    Console.Write($"{figurinhas.ToString().Trim("Abstracao.Classes.Entidades.")} - Cor: {figurinhas.Cor()} - Area da figura: ");
    figurinhas.Area();
figurinhas.Area
}